...
public class Dungeon extends Decorator<Decorator.Config, Dungeon.Data> {
    ...
    public static final VersionMap<Config> CONFIGS = new VersionMap<Config>()
            ...
            .add(MCVersion.v1_18, new Config(3, 2));
    ...
    @Override
    public boolean canStart(Data data, long worldSeed, ChunkRandom rand) {
    ...
    public Data at(int blockX, int blockY, int blockZ, Vec3i size, int[] floorCalls, Biome biome, HeightContext heightContext) {
        return new Data(this, blockX, blockY, blockZ, size, floorCalls, biome, heightContext);
    }
