...
public final class StarscriptUtils {
    ...
    /**
     * Runs the script and returns a raw string. Throws {@link StarscriptError} if a runtime error occurs.
     *
     * @author Crosby
     * @since 0.2.4
     */
    ...
    /**
     * Runs the script and fills the provided {@link StringBuilder} and returns a raw string. Throws {@link StarscriptError} if a runtime error occurs.
     *
     * @author Crosby
     * @since 0.2.4
     */
