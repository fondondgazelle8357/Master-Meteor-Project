...
public class VClip extends Command {
    ...
    private boolean doAutoClipDown(float incr) {
        ...
        for(float i = incr; incr > 0 ? i <= 10 : i >= -10; i += incr) {
            if(getBlock(pos.add(0, (int) i, 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i - 1), 0)) == Blocks.AIR) {
    ...
    private boolean doAutoClipUp(float incr) {
        ...
        if(incr == 0) incr = 1;
        for(float i = incr; incr > 0 ? i <= 10 : i >= -10; i += incr) {
            if(getBlock(pos.add(0, (int) i, 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 1), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 2), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 3), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 4), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 5), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 6), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 7), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 8), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 9), 0)) == Blocks.AIR && getBlock(pos.add(0, (int) (i + 10), 0)) == Blocks.AIR) {
                ChatUtils.info("Found clip block " + i + " blocks " + (incr > 0 ? "up" : "down") + ".");
                if (player.hasVehicle()) {
                    Entity vehicle = player.getVehicle();
