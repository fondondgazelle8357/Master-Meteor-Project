...
public class RenderUtils {
    ...
    public static void renderText(Vec3d vec3d, String text) {
        ...
        VertexConsumerProvider v = immediate;
        mc.textRenderer.draw("SUS", -mc.textRenderer.getWidth(text) / 2f, -mc.textRenderer.fontHeight / 2f, new Color(255, 255, 255, 255).getRGB(), false, matrix, v, null, 69, 15728880, true);
    }
