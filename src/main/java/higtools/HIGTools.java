...
public class HIGTools extends MeteorAddon {
    private static final ModMetadata metadata = FabricLoader.getInstance().getModContainer("viafabric-mc").orElseThrow(() -> new RuntimeException("HIGTools mod container not found!")).getMetadata();
