    ...
    private void onTick(TickEvent.Post event) {
        switch (mode.get()) {
            ...
            case Block -> {
                ...
                Vec3i p = new Vec3i((int) mc.player.getX(), (int) mc.player.getY(), (int) mc.player.getZ());
                BlockHitResult bhr = new BlockHitResult(pos, Direction.DOWN, new BlockPos(p), false);
                for (int i = 0; i < amount.get(); i++) {
